...
from aixing_tools.infer.utility import base64_to_cv2
from aixing_tools.infer.predict_rec import TextRecognizer
from aixing_tools.infer.utility import parse_args
